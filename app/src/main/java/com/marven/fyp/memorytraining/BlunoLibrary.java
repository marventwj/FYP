...
//	}
	...
	public void setConnectionStateConnected(){
		mConnectionState = connectionStateEnum.isConnected;
	}

	public boolean getServiceConnectedStatus() {return serviceConnected;}

//	public void serialSendByte(byte[] theBytes) {
//		if (mConnectionState == connectionStateEnum.isConnected) {
//			mSCharacteristic.setValue(theBytes);
//			mBluetoothLeService.writeCharacteristic(mSCharacteristic);
//		}
//	}
...
//	byte[] mBaudrateBuffer={0x32,0x00,(byte) (mBaudrate & 0xFF),(byte) ((mBaudrate>>8) & 0xFF),(byte) ((mBaudrate>>16) & 0xFF),0x00};;
	...
	public void onCreateProcess() {
		...
		mScanDeviceDialog = new AlertDialog.Builder(mainContext)
				.setTitle("Scanning for Bluno..").setAdapter(mLeDeviceListAdapter, new DialogInterface.OnClickListener() {
...
//            	System.out.println(mPlainProtocol.mReceivedframe.toString());
    ...
    void buttonScanOnClickProcess()
    {
		...
		case isNull:
			...
			onConectionStateChange(mConnectionState);
			scanLeDevice(true);
			//mScanDeviceDialog.show();					//uncomment this if want to show the list adapter@@@@@@@@@@@@@@@@@
		...
		public void onLeScan(final BluetoothDevice device, int rssi,
			...
			((Activity) mainContext).runOnUiThread(new Runnable() {
				...
				public void run() {
					...
					if (device.getAddress().equals("BC:6A:29:B1:02:60")) {            //comment off this if you want to scan all BLE device instead with list adapter.@@@@@@@
						scanLeDevice(false);
					...
					//mLeDeviceListAdapter.notifyDataSetChanged();					//uncomment  this if you want to use list adapter.@@@@@@@@@@@@@@@@@@@@@
				}
			});
		}
	};
...
//                    updateConnectionState(R.string.comm_establish);
	...
	private class LeDeviceListAdapter extends BaseAdapter {
		...
		public View getView(int i, View view, ViewGroup viewGroup) {
			...
			if (deviceName != null && deviceName.length() > 0)             //uncomment if want to show all BLE device scanned
				viewHolder.deviceName.setText(deviceName);
			else                                                          //uncomment if want to show all BLE device scanned
				viewHolder.deviceName.setText(R.string.unknown_device);   //uncomment if want to show all BLE device scanned
